...
final class CommentRouterTest extends AssignmentThreeTest
{
	...
	public function testCommentWasNotFoundByWrongId(): void
	{
		...
		$this->assertEquals('Cannot show Comment: Comment does not exist with ID 1.', $retrievedComment['message']);

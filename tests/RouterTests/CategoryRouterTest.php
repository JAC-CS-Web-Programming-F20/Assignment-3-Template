...
namespace AssignmentThreeTests\RouterTests;

use AssignmentThreeTests\AssignmentThreeTest;

final class CategoryRouterTest extends AssignmentThreeTest
{
	...
	public function testCategoryWasNotFoundByWrongId(): void
	{
		...
		$this->assertEquals('Cannot show Category: Category does not exist with ID 1.', $retrievedCategory['message']);

...
namespace AssignmentThreeTests\ControllerTests;

use AssignmentThree\Controllers\CategoryController;
use AssignmentThree\Exceptions\CategoryException;
use AssignmentThree\Models\Category;
use AssignmentThree\Router\Request;
use AssignmentThree\Router\Response;
use AssignmentThreeTests\AssignmentThreeTest;

final class CategoryControllerTest extends AssignmentThreeTest
{
	...
	public function testExceptionWasThrownShowingCategory(string $exception, string $message, string $requestMethod, array $parameters): void
	{
		...
		(new CategoryController($request))->doAction();
	}
	...
	public function findCategoryProvider()
	{
		yield 'invalid ID' => [
			...
			'Cannot show Category: Category does not exist with ID 1.',
			'GET',
			[
				'body' => [],
				'header' => [1]

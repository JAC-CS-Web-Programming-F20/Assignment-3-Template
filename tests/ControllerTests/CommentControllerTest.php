...
use AssignmentThree\Controllers\CommentController;
use AssignmentThree\Exceptions\CommentException;
use AssignmentThree\Router\Request;
use AssignmentThree\Router\Response;
use AssignmentThreeTests\AssignmentThreeTest;

final class CommentControllerTest extends AssignmentThreeTest
{
	...
	public function testExceptionWasThrownShowingComment(string $exception, string $message, string $requestMethod, array $parameters): void
	{
		...
		(new CommentController($request))->doAction();
	}
	...
	public function findCommentProvider()
	{
		yield 'invalid ID' => [
			...
			'Cannot show Comment: Comment does not exist with ID 1.',
			'GET',
			[
				'body' => [],
				'header' => [1]
